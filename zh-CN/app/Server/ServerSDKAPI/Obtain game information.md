...
- 测试环境：接口地址详见[获取服务端API配置](Obtain%20server-end%20API%20configurations.md)中get_mg_info字段
- 生产环境：接口地址详见[获取服务端API配置](Obtain%20server-end%20API%20configurations.md)中get_mg_info字段
