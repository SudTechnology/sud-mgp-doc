...
* [客户端](app/Client/README.md)
    ...
    * [客户端文档](app/Client/README.md)
        ...
        * [APP状态转换器](app/Client/APPFST/README.md)
            * [通用状态](app/Client/APPFST/通用状态.md)
        * [MG状态机](app/Client/MGFSM/README.md)
            * [通用状态-游戏](app/Client/MGFSM/通用状态-游戏.md)
            * [通用状态-玩家](app/Client/MGFSM/通用状态-玩家.md)
            * [你画我猜](app/Client/MGFSM/你画我猜.md)
...
* [服务端](app/Server/README.md)
    ...
    * [JWT鉴权](app/Server/Auth/README.md)
        * [鉴权](app/Server/Auth/鉴权.md)
        * [数据交换](app/Server/Auth/数据交换.md)
