...
* [客户端](app/Client/README.md)
    ...
    * [客户端文档](app/Client/README.md)
        ...
        * [APP状态转换器](app/Client/APPFST/README.md)
            * [通用状态](app/Client/APPFST/CommonState.md)
        * [MG状态机](app/Client/MGFSM/README.md)
            * [通用状态-游戏](app/Client/MGFSM/CommonStateGame.md)
            * [通用状态-玩家](app/Client/MGFSM/CommonStatePlayer.md)
...
* [服务端](app/Server/README.md)
    ...
    * [SDK服务API](app/Server/ServerSDKAPI/README.md)
        * [获取游戏列表](app/Server/ServerSDKAPI/Obtain%20the%20game%20list.md)
        * [获取游戏信息](app/Server/ServerSDKAPI/Obtain%20game%20information.md)
        * [获取游戏上报信息](app/Server/ServerSDKAPI/Obtain%20the%20report%20information%20of%20game.md)
        * [分页获取房间内游戏上报信息](app/Server/ServerSDKAPI/Obtain%20the%20report%20information%20of%20game%20by%20page.md)
        * [获取服务端接口API配置](app/Server/ServerSDKAPI/Obtain%20server-end%20API%20configurations.md)
