...
* [Server](app/Server/README.md)
    ...
    * [SDK service API](app/Server/ServerSDKAPI/README.md)
        * [获取游戏列表](app/Server/ServerSDKAPI/Obtain the game list.md)
        * [获取游戏信息](app/Server/ServerSDKAPI/Obtain game information.md)
        * [获取游戏上报信息](app/Server/ServerSDKAPI/Obtain the report information of game.md)
        * [分页获取房间内游戏上报信息](app/Server/ServerSDKAPI/Obtain the report information of game by page.md)
        * [获取服务端接口API配置](app/Server/ServerSDKAPI/Obtain server-end API configurations.md)
