...
* [Server](app/Server/README.md)
    ...
    * [SDK service API](app/Server/ServerSDKAPI/README.md)
        * [Obtain the game list](app/Server/ServerSDKAPI/Obtain the game list.md)
        * [Obtain game information](app/Server/ServerSDKAPI/Obtain game information.md)
        * [Obtain the report information of game](app/Server/ServerSDKAPI/Obtain the report information of game.md)
        * [Obtain the report information of game by page](app/Server/ServerSDKAPI/Obtain the report information of game by page.md)
        * [Obtain server-end API configurations](app/Server/ServerSDKAPI/Obtain server-end API configurations.md)
